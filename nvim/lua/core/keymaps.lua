...
-- Tmux Cheatsheet User Command
vim.api.nvim_create_user_command("TmuxHelp", function()
    vim.cmd("!bat --style=plain ~/.config/tmux/cheatsheet.md")
end, { desc = "Show Tmux Cheatsheet" })

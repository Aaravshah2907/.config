...
return {
	...
	},
	{
		...
		keys = {
			{ "<leader>ji", "<cmd>MoltenInit<cr>", desc = "Notebook: Initialize kernel" },
			{ "<leader>jr", "<cmd>MoltenEvaluateOperator<cr>", desc = "Notebook: Run operator" },
			{ "<leader>jrr", "<cmd>MoltenEvaluateLine<cr>", desc = "Notebook: Run line" },
			{ "<leader>jr", ":<c-u>MoltenEvaluateVisual<cr>gv", mode = "v", desc = "Notebook: Run selection" },
		...
		config = function()
			-- Molten configuration options initialized in init()
		end,
	},
	{
		"Vigemus/iron.nvim",

			...
			if status_f then
				...
				if out and #out > 0 then
					...
					ya.manager_emit("plugin", {
						"syl-notify",
						args = ya.quote("custom") .. " " .. ya.quote("󰊢 Memories") .. " " .. ya.quote(
							"This place holds memories... " .. count .. " of them are changing!"
						),
					})
				else
					ya.manager_emit("plugin", {
						"syl-notify",
						args = ya.quote("custom") .. " " .. ya.quote("󰊢 Memories") .. " " .. ya.quote(
							"All patterns are stable here. No unsynced changes."
						),
					})
				end
			end
